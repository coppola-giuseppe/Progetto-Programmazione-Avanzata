 ...
 * @author coppo
 */
public class MagicItemEncoded implements Serializable, GameData {
    ...
    public MagicItemEncoded(String magicItemsIndex, String name, List<String> description, String image, String rarity) {
        this.magicItemsIndex = magicItemsIndex;
        this.name = name;
        this.description = description;
        this.image = image;
